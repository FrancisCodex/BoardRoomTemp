          ...
          <div className="w-full py-6 z-20">
            ...
            <form onSubmit={handleRegistration} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto"> {/* action="/profile" */}
              <div className="pb-1 pt-3">
                <input onChange={handleInputChange} value={registrationData.firstname} type="text" name="firstname" id="firstname" placeholder="First Name" className="block w-full p-4 text-lg rounded-sm bg-black" />
              </div>
              <div className="pb-1 pt-3">
                <input onChange={handleInputChange} value={registrationData.lastname} type="text" name="lastname" id="lastname" placeholder="Last Name" className="block w-full p-4 text-lg rounded-sm bg-black" />
              </div>
              <div className="pb-1 pt-3">
                <input onChange={handleInputChange} value={registrationData.email} type="email" name="email" id="email" placeholder="Email" className="block w-full p-4 text-lg rounded-sm bg-black" />
              </div>
              <div className="pb-1 pt-3">
              <input
                  type="password"
